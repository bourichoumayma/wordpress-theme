...
class Winterblues_Social_Icons_Widget extends WP_Widget {
  ...
  public function update( $new_instance, $old_instance ) {
    ...
    $instance['text_1']     = isset( $new_instance['text_1'] ) ? wp_strip_all_tags( $new_instance['text_1'] ) : '';
    $instance['text_2']     = isset( $new_instance['text_2'] ) ? wp_strip_all_tags( $new_instance['text_2'] ) : '';
    $instance['text_3']     = isset( $new_instance['text_3'] ) ? wp_strip_all_tags( $new_instance['text_3'] ) : '';
    $instance['text_4']     = isset( $new_instance['text_4'] ) ? wp_strip_all_tags( $new_instance['text_4'] ) : '';
    $instance['text_5']     = isset( $new_instance['text_5'] ) ? wp_strip_all_tags( $new_instance['text_5'] ) : '';
